...
// in `index.html`.
setRootPath(MainInitGlobals.rootPath);class MainInit extends PolymerElement{static get template(){return html`
      <style>
        :host {
...
if(!page){this.page="list"}else if(-1!==["list","add","edit"].indexOf(page)){this.page=page}else{this.page="error404"}if(!this.$.drawer.persistent){this.$.drawer.close()}}_pageChanged(page){switch(page){case"list":import("./account-list.js").then(bundle=>bundle&&bundle.$accountList||{});break;case"add":import("./account-add.js").then(bundle=>bundle&&bundle.$accountAdd||{});break;case"edit":import("./account-edit.js").then(bundle=>bundle&&bundle.$accountEdit||{});break;case"error404":import("./error-404.js").then(bundle=>bundle&&bundle.$error$404||{});break;}}}window.customElements.define("main-init",MainInit);